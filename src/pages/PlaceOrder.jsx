      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            <div className='flex items-center gap-3 border p-2 px-3 cursor-pointer' onClick={()=>setMethod('paystack')}>
            ...
            <div className='flex items-center gap-3 border p-2 px-3 cursor-pointer' onClick={()=>setMethod('bt')}>
              <p className={`min-w-3.5 h-3.5 border rounded-full ${method === 'bt' ? 'bg-green-400' : ''}`}></p>
              <p className='mx-4 text-gray-500 text-sm font-medium'>BANK TRANSFER</p>
            </div>
          </div>
